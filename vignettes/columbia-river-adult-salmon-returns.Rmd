...
Since years before 2002 only collected data from March 15 to November 15, we exclude observations from outside those days from 2002 and later, in order to be comparing similar sets of data across all years.
...
&#x1F53B;&nbsp;_To Do_: Need to calculate quantitative measure of (lack of) correlation between the total returns for the two species.&nbsp;&#x1F53A;

&#x1F53B;&nbsp;_To Do_: Add other species to the plot. Change to a line plot?&nbsp;&#x1F53A;
